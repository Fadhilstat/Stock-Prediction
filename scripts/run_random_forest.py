"""Run Random Forest model selection for every ticker."""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "reports" / "ml" / "random_forest"


def parse_arguments() -> argparse.Namespace:
    """Parse command-line arguments."""

    parser = argparse.ArgumentParser(description=("Select and evaluate Random Forest per ticker."))
...
def main() -> int:
    """Run Random Forest for all tickers."""
    ...
    model_config = RandomForestSearchConfig(
    ...
    for ticker, group in dataset.groupby(
        ...
        validation_predictions["model_name"] = "random_forest"
